...
public class MapActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // インテントから引継ぎデータを取得する。
        mUserId   = intent.getStringExtra(Key.USER_ID);
        mRoomNo   = intent.getLongExtra(Key.ROOM_NO, 0);
        mPassword = intent.getStringExtra(Key.PASSWORD);
        mNickname = intent.getStringExtra(Key.NICKNAME);
        ...
        // 開始切替ボタンにリスナーを設定する。
        ((ToggleButton)findViewById(R.id.startButton)).setOnCheckedChangeListener(
            new StartButtonOnCheckedChangeListener());
        ...
        public void onConnectionFailed(ConnectionResult connectionResult) {
            ...
            if (connectionResult.hasResolution()) {
                try {
                    ...
                    connectionResult.startResolutionForResult(MapActivity.this, RequestCode.CONNECTION_FAILURE_RESOLUTION_REQUEST);
        ...
        public void onLocationChanged(Location location) {
            ...
            if (mStartFlg) {
                ...
                if (!mProcessingFlg) {
                    ...
                    bundle.putString(Key.USER_ID,	mUserId);
                    bundle.putLong(  Key.ROOM_NO,   mRoomNo);
                    ...
                    getSupportLoaderManager().restartLoader(
                            ...
                            bundle,
                            new HttpLoaderCallbacks(MapActivity.this));
                } else {
...
//					  Toast.makeText(mContext, "Response=[" + response + "]", Toast.LENGTH_SHORT).show();
                    try {
                        ...
                        for (int i = 0; i < locations.length(); i++) {
                            ...
                            // ユーザーIDを取得する。
                            String userId = location.getString(Key.USER_ID);
     ...
     *
     */
    private class StartButtonOnCheckedChangeListener implements OnCheckedChangeListener {

        /** ロガー */
        private Logger mLogger = new Logger(StartButtonOnCheckedChangeListener.class);
