 ...
 * @version 1.0 新規作成
 */
public class CreateRoomLoaderCallbacks extends AbstractBaseLoaderCallbacks {

    /** ロガー */
    private Logger mLogger = new Logger(CreateRoomLoaderCallbacks.class);
     ...
     */
    public CreateRoomLoaderCallbacks(Context context, OnReceiveResponseListener listener) {
    ...
    private static class HttpPostLoader extends AbstractHttpPostLoader {
        ...
        protected List<NameValuePair> setEntities() {
            ...
            entities.add(new BasicNameValuePair(HttpKey.OWNER_ID,   mParams.getString(HttpKey.OWNER_ID)));
            entities.add(new BasicNameValuePair(HttpKey.OWNER_NAME, mParams.getString(HttpKey.OWNER_NAME)));
