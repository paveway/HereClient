 ...
 * @version 1.0 新規作成
 */
public class LoginLoaderCallbacks extends AbstractBaseLoaderCallbacks {

    /** ロガー */
    private Logger mLogger = new Logger(LoginLoaderCallbacks.class);
     ...
     */
    public LoginLoaderCallbacks(Context context, OnReceiveResponseListener listener) {
