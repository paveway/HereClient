 ...
 * @version 1.0 新規作成
 */
public class ExitRoomLoaderCallbacks extends AbstractBaseLoaderCallbacks {

    /** ロガー */
    private Logger mLogger = new Logger(ExitRoomLoaderCallbacks.class);
     ...
     */
    public ExitRoomLoaderCallbacks(Context context, OnReceiveResponseListener listener) {
