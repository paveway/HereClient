 ...
 * @version 1.0 新規作成
 */
public class RegistUserLoaderCallbacks extends AbstractBaseLoaderCallbacks {

    /** ロガー */
    private Logger mLogger = new Logger(RegistUserLoaderCallbacks.class);
     ...
     */
    public RegistUserLoaderCallbacks(Context context, OnReceiveResponseListener listener) {
