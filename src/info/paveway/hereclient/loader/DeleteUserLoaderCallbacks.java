 ...
 * @version 1.0 新規作成
 */
public class DeleteUserLoaderCallbacks extends AbstractBaseLoaderCallbacks {

    /** ロガー */
    private Logger mLogger = new Logger(DeleteUserLoaderCallbacks.class);
     ...
     */
    public DeleteUserLoaderCallbacks(Context context, OnReceiveResponseListener listener) {
